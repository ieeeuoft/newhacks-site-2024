...
REGISTRATION_CLOSE_DATE = datetime(2024, 10, 10, 23, 59, 0, tzinfo=TZ_INFO) #TODO: Confirm with logistics (close date: OCT 10)
APPLICATION_OPEN_DATE = datetime(2024, 10, 1, 0, 0, 0, tzinfo=TZ_INFO) #TODO: Confirm with logistics: Tentative application date: October 1st
